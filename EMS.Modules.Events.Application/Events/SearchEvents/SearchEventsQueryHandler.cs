    ...
    : IQueryHandler<SearchEventsQuery, SearchEventsResponse>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        IReadOnlyCollection<EventResponse> events = await GetEventAsync(connection, parameters);
    ...
    private static async Task<IReadOnlyCollection<EventResponse>> GetEventAsync(
