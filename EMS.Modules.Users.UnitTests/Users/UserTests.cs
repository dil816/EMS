...
using EMS.Modules.Users.UnitTests.Abstractions;
using FluentAssertions;

namespace EMS.Modules.Users.UnitTests.Users;
public class UserTests
{
    ...
    public void Create_ShouldRaiseDomainEvent_WhenUserCreated()
    {
        ...
        UserRegisteredDomainEvent domainEvent =
            BaseTest.AssertDomainEventWasPublished<UserRegisteredDomainEvent>(user);
    ...
    public void Update_ShouldRaiseDomainEvent_WhenUserUpdated()
    {
        ...
        UserProfileUpdatedDomainEvent domainEvent =
            BaseTest.AssertDomainEventWasPublished<UserProfileUpdatedDomainEvent>(user);
